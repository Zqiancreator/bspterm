...
"#;
    ...
    fn configure_shortcut_bar(
        &mut self,
        _: &ConfigureShortcutBar,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    fn deploy_shortcut_bar_context_menu(
        &mut self,
        position: Point<Pixels>,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    fn render_shortcut_bar(&self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        h_flex()
            ...
            .on_mouse_down(
                MouseButton::Right,
                cx.listener(|this, event: &MouseDownEvent, window, cx| {
                    this.deploy_shortcut_bar_context_menu(event.position, window, cx);
                    cx.stop_propagation();
                }),
            )
            .child(
...
fn terminal_rerun_override(task: &TaskId) -> bspterm_actions::Rerun {
    bspterm_actions::Rerun {

...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            terminal_tab_active_background: indigo().light().step_4(),
            terminal_gutter_separator: neutral().light().step_6(),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            terminal_tab_active_background: indigo().dark().step_4(),
            terminal_gutter_separator: neutral().dark().step_6(),
